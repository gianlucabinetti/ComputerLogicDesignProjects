...
vlib work && vcom '-2019' '-o' design.vhd testbench.vhd  && vsim -c -do "vsim TB_D_FlipFlop; run 140 ns; exit"  ; echo 'Creating result.zip...' && zip -r /tmp/tmp_zip_file_123play.zip . && mv /tmp/tmp_zip_file_123play.zip result.zip